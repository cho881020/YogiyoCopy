...
public class MainActivity extends BaseActivity {
    ...
    private void addListDatas() {
        ...
        GlobalData.storeDataList.add(new StoreData("https://s3.ap-northeast-2.amazonaws.com/slws3/imgs/tje_practice/one_logo.jpg", "원할머니보쌈-종로5가점", 3.8f, 1100, 300, 25000, false, "654-78-32145", "원할머니보쌈종로점"));
        GlobalData.storeDataList.add(new StoreData("https://www.yogiyo.co.kr/media/restaurant_logos/%EB%96%A1%EB%B3%B6%EC%9D%B4%EC%88%9C%EB%8C%80%EC%84%B8%ED%8A%B801_20131128_FoodAD_crop_200x200_yjnTv3z.jpg", "스쿨스토어-종로점", 4.2f, 1200, 2330, 15000, true, "321-45-78962", "스쿨스토어종로점"));
        GlobalData.storeDataList.add(new StoreData("https://www.yogiyo.co.kr/media/restaurant_logos/%EB%B3%B8%EB%8F%84%EC%8B%9C%EB%9D%BD_20150825_Franchise%EC%9D%B4%EB%AF%B8%EC%A7%80%EC%95%BD%EC%A0%95%EC%84%9C_crop_200x200_zY4cB53.jpg", "본도시락-서울시청점", 3.8f, 1100, 300, 25000, false, "654-32-78945", "본도시락서울시청점"));
...
//        원할머니 보쌈 2번, 훼미리피자 1번, 스쿨스토어 2번
        ...
        orderDataList.add(new OrderData(GlobalData.storeDataList.get(1),
                Calendar.getInstance(), "종로 3가", 25000));
        orderDataList.add(new OrderData(GlobalData.storeDataList.get(1),
                Calendar.getInstance(), "종로 1가", 15000));
        orderDataList.add(new OrderData(GlobalData.storeDataList.get(4),
                Calendar.getInstance(), "을지로 3가", 33000));
        orderDataList.add(new OrderData(GlobalData.storeDataList.get(2),
